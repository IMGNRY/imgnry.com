        ...
        <div class="about-wrapper" data-trigger>
          ...
          <div data-w-id="333849fc-cdf4-cf26-68aa-9be11dc69ae8" class="w-layout-grid project-about-section">
            ...
            <div class="summary-wrapper">
              <h3 class="everything">Project</h3>
              <p class="project-paragraph">
                TUI, the world largest leisure travel company, handed us the glorious task to design the Nordic web and email presence for 3 years. We
                also helped build the UX team that during this period was appointed ‘Center of Excellence’ on the TUI global level.
              </p>
            </div>
            <div id="w-node-342157ea9407-aa056f6f" class="summary-wrapper">
              <h3 class="everything">Our role</h3>
        ...
        <div class="about-wrapper" data-trigger>
          ...
          <div data-w-id="2a141d78-82b3-0fc2-dbd8-88aa31a3d6eb" class="w-layout-grid project-about-section">
            <div id="w-node-88aa31a3d6ec-aa056f6f" class="quote-wrapper">
              ...
              <div class="quote-text-wrapper">
                <blockquote class="quote-text">
                  ⭐️⭐️⭐️⭐️⭐️Very underrated game! There are not many apps like this one on the App Store 👌. This game was definitely very ahead
                  of its time. The concept, and design goes hand in hand with its awesome sound tracks as well.
                </blockquote>
            ...
            <div class="quote-wrapper">
              ...
              <div class="quote-text-wrapper">
                <blockquote class="quote-text">
                  ...
                  everything from specification to bug fixing. I can recommend him for any mobile development team, where I believe he will be a great
                  asset!”
                </blockquote>
        ...
        <div class="about-wrapper" data-trigger>
          ...
          <div data-w-id="c749924a-4fb5-b5a3-8583-79e1a0199a56" class="w-layout-grid project-about-section">
            ...
            <div class="summary-wrapper">
              <h3 class="everything">Project</h3>
              <p class="project-paragraph">
                This iOS game and its users never slept due to its 24/7 nature. Track down friends, earn cash and climb the bank ranks and at the same
                time stay on the run to gain the number one spot as the most wanted.
              </p>
            </div>
        ...
        <div class="about-wrapper" data-trigger>
          ...
          <div data-w-id="157f51e7-df97-80b0-f08e-fce6a071cfdc" class="w-layout-grid project-about-section">
            <div id="w-node-fce6a071cfdd-aa056f6f" class="quote-wrapper">
              ...
              <div class="quote-text-wrapper">
                <blockquote class="quote-text">
                  I have had the pleasure of working with Fille and his colleagues at IMGNRY in several projects, as subcontractors to Mobiento. I am
                  impressed with the passion they put in and the quality they deliver. Fille is a real team player, and a great asset to any team.
                </blockquote>
            ...
            <div class="summary-wrapper">
              <h3 class="everything">Project</h3>
              <p class="project-paragraph">
                Contracted by Mobiento to develop Systembolagets mobile app for searching, favorizing and rating their vast selection of beverages. It
                became the number #1 app in the App Store in the food category in Sweden.
              </p>
            </div>
