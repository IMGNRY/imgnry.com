<template>
  <div>
    <div id="top" class="nightsky-section hero">
      ...
      <lazy-img name="polaroid-fille.png" class="photo"></lazy-img>
      <h1>Fille Åström</h1>
    ...
    <div class="projects-section">
      <div class="container-max-1320">
          ...
          <div class="about-wrapper" data-trigger>
            ...
            <div data-w-id="2a141d78-82b3-0fc2-dbd8-88aa31a3d6eb" class="w-layout-grid project-about-section">
              ...
              <div class="summary-wrapper">
                <h3 class="everything">Project</h3>
                <p class="project-paragraph">
                  Multiplayer game where up to 4 players battle each other in capture the flag. First version played locally using iPad as the screen
                  and iPhones as game controller. Later rewritten with Unity for online multiplayer support on desktop for the Steam platform.
                </p>
              </div>
              <div id="w-node-88aa31a3d6f8-aa056f6f" class="summary-wrapper">
                ...
                <div class="tags-wrapper">
                  ...
                  <div class="tag">c#</div>
                  <div class="tag">steam</div>
                  <div class="tag">ios</div>
                  <div class="tag">objective-c</div>
                  <div class="tag">bluetooth</div>
                  <div class="tag">game design</div>
                  <div class="tag">real-time multiplayer</div>
                  <div class="tag">network physics</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="about-wrapper" data-trigger>
            ...
            <div data-w-id="47502ef1-2e86-8c52-30e2-ad5b872df8c9" class="w-layout-grid project-about-section">
              <div class="quote-wrapper">
                ...
                <div class="quote-text-wrapper">
                  <blockquote class="quote-text">
                    Working with Fille means that you will get a dedicated team player who brings energy to the project! Fille’s capabilities as a
          ...
          <div class="about-wrapper" data-trigger>
            ...
            <div data-w-id="48f49937-86c7-881e-2223-11f9144d0045" class="w-layout-grid project-about-section">
              ...
              <div class="summary-wrapper">
                <h3 class="everything">Project</h3>
                <p class="project-paragraph">
                  Multiplayer reaction based tournament game, where everybody compete against at each other asynchronously. We teamed up with a 3D
                  artist and a musician to create some cool assets.
                </p>
              </div>
            ...
            <div data-w-id="4ac542d6-8f37-2f2c-9435-4dda8e7da797" class="w-layout-grid project-about-section">
              ...
              <div id="w-node-4dda8e7da7a4-aa056f6f" class="summary-wrapper">
                ...
                <div class="tags-wrapper">
                  ...
                  <div class="tag">real-time strategy</div>
                  <div class="tag">multiplayer</div>
                  <div class="tag">game design</div>
                </div>
              </div>
        ...
        <div class="project">
          <!-- <div class="w-layout-grid project-title-row" data-trigger>
            <div class="project-title-line"></div>
            <h2 class="project-title">Say hi!</h2>
            <div class="project-title-line"></div>
          </div> -->
          <div class="contact">
            <!-- <lazy-img name="photo-fille.png" class="photo"></lazy-img> -->
            <div class="text">
              <!-- <div class="name" data-trigger>Fille Åström</div> -->
              <div class="row">
                <img src="images/at-sign.svg" class="icon" data-trigger />
                <a class="label" data-trigger href="mailto:fille@imgnry.com">fille@imgnry.com</a>
              </div>
              <div class="row">
                <img src="images/logo-linkedin.svg" class="icon" data-trigger />
                <a href="http://linkedin.com/in/fille" class="label" data-trigger>linkedin.com/in/fille</a>
              </div>
              <div class="row">
                <img src="images/phone.svg" class="icon" data-trigger />
                <p class="label" data-trigger>+46 709 36 78 32</p>
              </div>
            </div>
          </div>
        </div>
