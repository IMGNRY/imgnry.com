      ...
      <div class="container-max-1320">
          ...
          <div class="about-wrapper" data-trigger>
            ...
            <div data-w-id="a73b6af2-1979-2ce9-74c9-84e6cccc4302" class="w-layout-grid project-about-section">
              ...
              <div id="w-node-84e6cccc430f-aa056f6f" class="summary-wrapper">
                <h3 class="everything">My role</h3>
                <div class="tags-wrapper">
                  <div class="tag green">Everything except code</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="project">
          ...
          <div class="contact">
            ...
            <div class="text">
              <div class="name" data-trigger>Kristofer Guldvarg</div>
              <div class="row">
                <img src="images/phone.svg" class="icon" data-trigger />
                <p class="label" data-trigger>+46 72 703 78 78</p>
              </div>
              <div class="row">
                <img src="images/at-sign.svg" class="icon" data-trigger />
                <a class="label" data-trigger href="mailto:kristofer@imgnry.com">kristofer@imgnry.com</a>
              </div>
              <div class="row">
                <img src="images/logo-linkedin.svg" class="icon" data-trigger />
                <a href="http://linkedin.com/in/guldvarg" class="label" data-trigger>linkedin.com/in/guldvarg</a>
              </div>
            </div>
          </div>
        </div>
...
export default class App extends Vue {
  async mounted() {
    ...
    document.title = 'Kristofer Guldvarg'
  }
}
</script>
